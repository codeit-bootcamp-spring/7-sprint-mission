...
public class AWSS3Test {
    ...
    static void setUp() throws IOException {
        ...
        // 2. 값 할당 (파일 우선 -> 없으면 시스템 환경변수)
        accessKey = getValue(properties, "AWS_S3_ACCESS_KEY");
        secretKey = getValue(properties, "AWS_S3_SECRET_KEY");
        region = getValue(properties, "AWS_S3_REGION");
        bucketName = getValue(properties, "AWS_S3_BUCKET");
