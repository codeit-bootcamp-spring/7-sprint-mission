...
public class UserStatus extends BaseEntity<UUID> {
    ...
    public boolean isOnline() { return this.currentStatus == Status.ONLINE; }
    public boolean isOffline() { return this.currentStatus == Status.OFFLINE; }
    public boolean isAway() { return this.currentStatus == Status.AFK; }
    public boolean isDoNotDisturb() { return this.currentStatus == Status.DND; }
