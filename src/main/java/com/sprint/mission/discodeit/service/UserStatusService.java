...
public interface UserStatusService {
    ...
    UserStatusResponseDto update(UUID userStatusId, UpdateUserStatusRequestDto request);
    UserStatusResponseDto updateByUserId(UUID userId, UpdateUserStatusRequestDto request);
