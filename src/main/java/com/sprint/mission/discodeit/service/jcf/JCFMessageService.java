...
public class JCFMessageService implements MessageService {
    //싱글톤 구현
    private final static JCFMessageService jcfMessageService = new JCFMessageService();
    ...
    //레포지토리
    private final JCFMessageRepository jcfMessageRepository = JCFMessageRepository.getInstance();
