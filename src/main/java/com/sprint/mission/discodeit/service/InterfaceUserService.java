...
public interface InterfaceUserService {
    UserDto create(UserCreateRequest userDt, Optional<Dto_BinaryContent> content);
    UserDto find(UUID userID);      // 읽기
    List<UserDto> findAll();             // 모두 읽기
    UserDto update(UUID userId, Dto_UserUpdate dto_userUpdate, Optional<Dto_BinaryContent> requestDto_Content); // 수정
