...
//        UserResponseDTO updatedUser = userService.updateProfile(user.getId(), newNickname, newEmail, null);
...
//        String username = sc.nextLine();
//        UserResponseDTO foundUser = userService.findByUsernameNonDel(username);
