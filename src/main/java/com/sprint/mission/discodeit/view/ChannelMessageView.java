...
//        ParticipationResponseDTO participation = sharedView.selectParticipationFromUser(sender);
...
//        channelMessageService.sendMessage(participation.channelId(), sender.getId(), message);
