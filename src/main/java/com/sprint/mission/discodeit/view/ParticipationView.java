...
//        ParticipationResponseDTO participation = sharedView.selectParticipationFromUser(user);
//        if (participation == null) return;
//
//        System.out.print("새 닉네임: ");
//        String newNickname = sc.nextLine();
//
//        participationService.changeNickname(participation.channelId(), user.getId(), newNickname);
...
//        if (participation == null) return;
//
//        participationService.leaveChannel(participation.channelId(), user.getId());
...
//        if (participation == null) return;
//
//        participationService.deleteById(new ParticipationDualKey(participation.channelId(), participation.authorId()));
...
//                .forEach(p -> {
//                    try {
//                        User user = userService.findById(p.authorId());
//                        System.out.println("- " + user.getUsername() + " (닉네임: " + p.nickname() + ", 역할: " + p.role() + ")");
//                    } catch (Exception e) {
//                        System.out.println("- " + p.authorId() + " (사용자 정보 없음)");
//                    }
//                });
//    }
//
...
//                .forEach(p -> {
//                    try {
//                        Channel channel = channelService.findById(p.channelId());
//                        System.out.println("- " + channel.getChannelName() + " (사용 닉네임: " + p.nickname() + ")");
//                    } catch (Exception e) {
//                        System.out.println("- " + p.channelId() + " (채널 정보 없음)");
//                    }
//                });
//    }
//}