...
public enum ErrorCode {
    ...
    VALID_FAIL("REQUEST VALIDATION FAIL"),
    INTERNAL_SERVER_ERROR("INTERNAL SERVER ERROR"),
    ACCESS_DENIED_ERROR("INSUFFICIENT PERMISSION DENIED"),
    UNAUTHORIZED_ERROR("UNAUTHORIZED USER ERROR"),
    NOTIFICIATION_NOT_EXIST("NOTIFICATION NOT EXIST");
