...
public enum ErrorCode {
  ...
  INVALID_PASSWORD("AUTH_002", HttpStatus.UNAUTHORIZED,
      "비밀번호가 올바르지 않습니다."),
  SIGNUP_EMAIL_INVALID("AUTH_003", HttpStatus.BAD_REQUEST,
      "회원가입 이메일 형식이 올바르지 않습니다."),
  SIGNUP_NICKNAME_INVALID("AUTH_004", HttpStatus.BAD_REQUEST,
      "회원가입 닉네임은 2글자 이상이어야 합니다."),
  SIGNUP_PASSWORD_INVALID("AUTH_005", HttpStatus.BAD_REQUEST,
