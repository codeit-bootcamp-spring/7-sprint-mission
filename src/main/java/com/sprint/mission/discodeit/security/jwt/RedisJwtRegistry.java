...
import com.sprint.mission.discodeit.global.event.UserLogInOutEvent;
        ...
        for (String userKey : userKeys) {
            ...
            for (int i = 0; i < tokens.size(); i++) {
                ...
                if (tokens.get(i) instanceof JwtInformation jwtInfo &&
                    ...
                    redisTemplate.opsForList().remove(userKey, 1, "REMOVED");
        ...
        for (String userKey : userKeys) {
            ...
            if (tokens != null) {
                ...
                for (int i = tokens.size() - 1; i >= 0; i--) {
                    if (tokens.get(i) instanceof JwtInformation jwtInfo) {
                        boolean isExpired =
                                !jwtTokenProvider.isAccessTokenValid(jwtInfo.getAccessToken()) ||
                                        !jwtTokenProvider.isRefreshTokenValid(jwtInfo.getRefreshToken());
