...
public enum ErrorCode {
  ...
  USERNAME_ALREADY_EXIST(HttpStatus.BAD_REQUEST, "USER_002", "중복된 사용자 이름입니다."),
  EMAIL_ALREADY_EXIST(HttpStatus.BAD_REQUEST, "USER_003", "중복된 이메일입니다."),

  //AUTH
  LOGIN_USER_NOT_FOUND(HttpStatus.NOT_FOUND, "AUTH_001", "존재하지 않는 사용자입니다."),
  ...
  // READ_STATUS
  READ_STATUS_ALREADY_EXIST(HttpStatus.BAD_REQUEST, "READ_001", "중복된 ReadStatus입니다."),
  ...
  USER_STATUS_ALREADY_EXIST(HttpStatus.BAD_REQUEST, "USERSTATUS_002", "이미 존재하는 UserStatus입니다."),
