...
(
    ...
    role       varchar(20)  not null default 'USER'
        CONSTRAINT fk_users_profile FOREIGN KEY
(
    profile_id
)
...
(
    ...
    CONSTRAINT fk_channel_participants_channel FOREIGN KEY
        (
         channel_id
            )
        REFERENCES channels
    ...
    CONSTRAINT fk_channel_participants_user FOREIGN KEY
        (
         user_id
            )
        REFERENCES users
...
(
    ...
    CONSTRAINT fk_messages_author FOREIGN KEY
        (
         author_id
            )
        REFERENCES users
    ...
    CONSTRAINT fk_messages_channel FOREIGN KEY
        (
         channel_id
            )
        REFERENCES channels
...
(
    ...
    CONSTRAINT fk_message_attachments_message FOREIGN KEY
        (
         message_id
            )
        REFERENCES messages
    ...
    CONSTRAINT fk_message_attachments_attachment FOREIGN KEY
        (
         attachment_id
            )
        REFERENCES binary_contents
...
(
    ...
    created_at     TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_user_statuses_user FOREIGN KEY
        (
         user_id
            )
        REFERENCES users
