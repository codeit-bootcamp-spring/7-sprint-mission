...
public class UserStatusController {
    ...
    public ResponseEntity<UserStatusResponse> createOnlineStatus(@RequestBody UserStatusCreateRequest request) {
        return ResponseEntity.status(HttpStatus.CREATED).body(userStatusService.create(request));
    }

    @RequestMapping(method = RequestMethod.PUT)
    public ResponseEntity<UserStatusResponse> updateOnlineStatus(@RequestBody UserStatusUpdateByUserIdRequest request) {
